...
#define MQTT_TOPIC             "heater_%06X"   // [Topic] unique MQTT device topic including (part of) device MAC address
...
#define WEB_PASSWORD           "tkatjd123"       // [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty string = Disable)
#define FRIENDLY_NAME          "heater_00"       // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
