...
//#define D_TEMPERATURE2 "내부온도1"
//#define D_TEMPERATURE3 "내부온도2"
//#define D_TEMPERATURE4 "내부온도3"
#define D_TO "to"
...
#define D_AP1_SSID_HELP "WiFi 네트워크를 선택하거나 입력하세요."
#define D_AP2_SSID "WiFi 네트워크 2"
#define D_AP2_SSID_HELP "보조 WiFi 네트워크를 입력하세요."
#define D_AP_PASSWORD "WiFi 비밀번호"
#define D_AP_PASSWORD_HELP "WiFi 비밀번호를 입력하세요."
#define D_SELECT_YOUR_WIFI_NETWORK "WiFi 네트워크를 선택하세요"
#define D_SHOW_MORE_WIFI_NETWORKS "모든 WiFi 네트워크 스캔"
#define D_SHOW_MORE_OPTIONS "More Options"
#define D_CHECK_CREDENTIALS "Please, check your credentials"
#define D_SUCCESSFUL_WIFI_CONNECTION "WiFi 연결 성공"
#define D_NOW_YOU_CAN_CLOSE_THIS_WINDOW "이제 이 창을 닫으실 수 있습니다."
#define D_REDIRECTING_TO_NEW_IP "새로운 IP 주소로 이동중"
...
// xdrv_23_zigbee
#define D_ZIGBEE_PERMITJOIN_ACTIVE "기기들이 연결되도록 허용되었습니다."
#define D_ZIGBEE_MAPPING_TITLE "지그비 매핑"
#define D_ZIGBEE_NOT_STARTED "지그비가 시작되지 않음."
#define D_ZIGBEE_MAPPING_IN_PROGRESS_SEC "맵 작성중 (%d 초. 남음)"
#define D_ZIGBEE_MAPPING_NOT_PRESENT "No mapping"
#define D_ZIGBEE_MAP_REFRESH "Zigbee Map Refresh"
#define D_ZIGBEE_MAP   "지그비 맵"
#define D_ZIGBEE_PERMITJOIN "지그비 연결 허용"
#define D_ZIGBEE_GENERATE_KEY "generating random Zigbee network key"
#define D_ZIGBEE_UNKNOWN_DEVICE "알수없는 기기"
#define D_ZIGBEE_UNKNOWN_ATTRIBUTE "알수없는 속성"
#define D_ZIGBEE_UNKNOWN_ENDPOINT "알수없는 엔드포인트"
#define D_ZIGBEE_INVALID_PARAM "잘못된 인수"
#define D_ZIGBEE_MISSING_PARAM "인수 없음"
#define D_ZIGBEE_UNKNWON_ATTRIBUTE "알수없는 속성 이름 (무시됨): %s"
...
#define D_MANAGE_FILE_SYSTEM   "파일시스템 관리"
#define D_FS_SIZE              "용량"
#define D_FS_FREE              "사용가능"
#define D_NEW_FILE             "newfile.txt"
#define D_CREATE_NEW_FILE      "새 파일 생성 및 편집"
#define D_EDIT_FILE            "Edit File"
#define D_CONFIRM_FILE_DEL     "Confirm file deletion"
#define D_SHOW_HIDDEN_FILES    "숨김 파일 표시"
